const translations = {
    ...
    "he": {
        ...
        "tutoring_desc": "אני מציע שיעורי מתמטיקה פרטיים לתלמידים בכל הגילאים. בין אם אתה צריך עזרה באלגברה, גיאומטריה או כל דבר אחר — אני פה לעזור. שלח הודעה ונתחיל!",
    ...
    "nl": {
        ...
        "tutoring_desc": "Ik geef persoonlijke wiskundebijles aan leerlingen van alle leeftijden. Of je nu hulp nodig hebt bij algebra, geometrie of iets anders — ik help je graag. Stuur me een bericht en we beginnen!",
