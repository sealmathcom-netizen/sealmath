...
export const translations: Record<Lang, Record<string, string>> = {
  ...
  he: {
    ...
    algebra_addsub_ex1: '<strong>דוגמה 1:</strong> <code style="font-family: var(--mono)">x + 3 = 5</code> <br/>מכיוון ש-3 <em>מחובר</em> ל-x, הקסם הוא לעשות את ההפך: <strong>לחסר 3</strong> משני הצדדים.<br/><code style="font-family: var(--mono)">x = 5 - 3 ➔ x = 2</code>',
    algebra_addsub_ex2: '<strong>דוגמה 2:</strong> <code style="font-family: var(--mono)">x - 4 = 6</code> <br/>מכיוון ש-4 <em>מוחסר</em> מ-x, נעשה את ההפך: <strong>נוסיף 4</strong> לשני הצדדים.<br/><code style="font-family: var(--mono)">x = 6 + 4 ➔ x = 10</code>',
    algebra_muldiv_desc: 'בדיוק כמו קודם, אנו משתמשים ב<strong>פעולה ההפוכה</strong> כדי לבודד את <strong>x</strong>.',
    algebra_muldiv_ex1: '<strong>דוגמה 1:</strong> <code style="font-family: var(--mono)">3x = 12</code> <br/>כאן, x <em>מוכפל</em> ב-3. הפעולה ההפוכה היא <strong>לחלק ב-3</strong> את שני הצדדים.<br/><code style="font-family: var(--mono)">x = 12 / 3 ➔ x = 4</code>',
    algebra_muldiv_ex2: '<strong>דוגמה 2:</strong> <code style="font-family: var(--mono)">x / 2 = 5</code> <br/>כאן, x <em>מחולק</em> ב-2. הפעולה ההפוכה היא <strong>להכפיל ב-2</strong> את שני הצדדים.<br/><code style="font-family: var(--mono)">x = 5 * 2 ➔ x = 10</code>',
  },
  nl: {
