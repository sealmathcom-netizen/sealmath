...
• Order matters for Subtraction and Division!`,
    ...
    algebra_needs_steps: '❌ Multi-step equation: Please show at least one intermediate step.',
    msg_must_show_steps: 'Multi-step equation: Please show at least one intermediate step.',
    msg_must_solve_for_x: 'Please solve entirely for the variable (e.g. x = 1).',
    msg_wrong_variable_used: 'Please use only the exercise variable in every step (e.g. use x, not a or b).',
    algebra_final_result: 'Final Result',
    algebra_step_label: 'Step',
    algebra_rounding_prompt: 'Round {0} to {1} decimal places: ',
    algebra_rounding_prompt_whole: 'Round {0} to the nearest whole number: ',
    ...
    word_prob_7: 'There are {0} 5-cent coins and some 10-cent coins. Total value is {1} cents. Find the number of 10-cent coins.',
    ...
    word_prob_11: 'A book costs x, another costs {0} more, and a third costs 2 times the first. Total is {1}. Find x.',
    ...
    error_equation_incorrect: '❌ The equation does not match the problem.',
    exam_finish: 'Finish Exam',
    exam_score: 'Your Score: {score}%',
    algebra_final_exam_solve_for_x: 'Solve for x: 3x = 9',
},
  he: {
    nav_home: 'בית',
    nav_game: 'אתגר ה-24',
...
• הסדר משנה בחיסור ובחילוק!`,
    ...
    algebra_needs_steps: '❌ משוואה רב-שלבית: אנא הראה לפחות שלב ביניים אחד.',
    msg_must_show_steps: 'משוואה רב-שלבית: אנא הראה לפחות שלב ביניים אחד.',
    msg_must_solve_for_x: 'אנא פתור את המשוואה במלואה עבור המשתנה (לדוגמה x = 1).',
    msg_wrong_variable_used: 'אנא השתמש רק במשתנה של התרגיל בכל שלב (לדוגמה: x ולא a או b).',
    ...
    algebra_rounding_prompt: 'עגלו את {0} ל-{1} ספרות עשרוניות: ',
    algebra_rounding_prompt_whole: 'עגלו את {0} למספר השלם הקרוב ביותר: ',
    ...
    word_prob_6: 'רכבת נוסעת ב-{0} קמ"ש זמן מה, ואז ב-{1} קמ"ש יותר במשך 2 שעות. המרחק הכולל הוא {2} ק"מ. מצאו את הזמן ההתחלתי.',
    ...
    error_equation_incorrect: '❌ המשוואה אינה תואמת את הבעיה.',
    exam_finish: 'סיים מבחן',
    exam_score: 'הציון שלך: {score}%',
    algebra_final_exam_solve_for_x: 'פתרו עבור x: 3x = 9',
},
  nl: {
    nav_home: 'Home',
...
• De volgorde telt bij Aftrekken en Delen!`,
    ...
    algebra_solution_steps: 'Oplosstappen',
    ...
    algebra_needs_steps: '❌ Meerstapvergelijking: laat a.u.b. ten minste één tussenstap zien.',
    msg_must_show_steps: 'Meerstapvergelijking: laat a.u.b. ten minste één tussenstap zien.',
    msg_must_solve_for_x: 'Los de vergelijking a.u.b. volledig op voor de variabele (bijv. x = 1).',
    msg_wrong_variable_used: 'Gebruik in elke stap alleen de variabele van de opgave (bijv. x, niet a of b).',
    algebra_final_result: 'Eindresultaat',
    algebra_step_label: 'Stap',
    algebra_rounding_prompt: 'Rond {0} af op {1} decimalen: ',
    algebra_rounding_prompt_whole: 'Rond {0} af op het dichtstbijzijnde gehele getal: ',
    ...
    error_equation_incorrect: '❌ De vergelijking komt niet overeen met het probleem.',
    exam_finish: 'Examen Beëindigen',
    exam_score: 'Je score: {score}%',
    algebra_final_exam_solve_for_x: 'Los op voor x: 3x = 9',
  },
};
