...
export const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    algebra_twostep_desc: 'For two-step equations like <strong>2x + 5 = 10</strong>, you must solve them in two phases. First, isolate the term with <strong>x</strong>. Second, solve for <strong>x</strong>. If your answer has more than two decimal places, round it properly to two decimals.',
  ...
  he: {
    ...
    algebra_twostep_desc: 'במשוואות בשני שלבים כמו <strong>2x + 5 = 10</strong>, יש לפתור בשני שלבים. תחילה בודד את האיבר עם <strong>x</strong>. לאחר מכן פתור עבור <strong>x</strong>. אם לתשובה יש יותר משתי ספרות עשרוניות, יש לעגל אותה לשתי ספרות במדויק.',
  ...
  nl: {
    ...
    algebra_twostep_desc: 'Voor tweestapsvergelijkingen zoals <strong>2x + 5 = 10</strong>, moet je in twee fasen oplossen. Eerst isoleer je de term met <strong>x</strong>. Daarna los je op voor <strong>x</strong>. Als je antwoord meer dan twee decimalen heeft, rond het dan correct af op twee decimalen.',
